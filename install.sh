...
directories=". .vice .gnupg .local/share/applications .local/share/cows .config .config/gtk-3.0 .config/fontconfig .config/nvim .config/nvim/after/ftplugin .config/mpv"
